...
public class HdfsDAO {
	...
	// HDFS访问地址
	private static final String HDFS = "hdfs://192.168.245.128:9000";
	// hdfs路径
	...
	public static JobConf config() {
		...
		conf.addResource("/home/kaka/hadoop/etc/hadoop/core-site.xml");
		conf.addResource("/home/kaka/hadoop/etc/hadoop/hdfs-site.xml");
		conf.addResource("/home/kaka/hadoop/etc/hadoop/mapred-site.xml");
		return conf;
	}
